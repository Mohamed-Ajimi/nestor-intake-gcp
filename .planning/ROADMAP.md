...
Plans:
- [ ] 22-01-PLAN.md — wave 1 — the shared normalize_source_url + collapse_citations_by_url, with tests, inside the engine fast gate (44 -> 45)
- [ ] 22-02-PLAN.md — wave 1 — frontend Citation type fields + the pure buildCitationIndex that honours the dedupe aliases
- [ ] 22-03-PLAN.md — wave 1 — every new locale key in three languages, citation.published -> citation.retrieved, and CitationMarker with its hover card
- [ ] 22-04-PLAN.md — wave 1 — D-22-5: the activity feed off the intake page, the Open run link kept
- [ ] 22-05-PLAN.md — wave 2 — the dedupe seam in build_verification_report + also_claim_ids on the wire model
- [ ] 22-06-PLAN.md — wave 2 — the route rename to .index.tsx, the new /verification route, and the run page CTA as a Link
- [ ] 22-07-PLAN.md — wave 3 — the instrumented document: stat strip, proportional funnel, anchored section blocks

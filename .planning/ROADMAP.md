...
- [ ] 23.1-03-PLAN.md — wave 1 — D-23.1-03 + D-23.1-13: space deactivation cascades to its members (IdP disable + revoke); reactivate restores only what the cascade took down; and login-sync's `_find_membership` gains the active-status predicate on both arms so a partial cascade cannot leave a member authenticating

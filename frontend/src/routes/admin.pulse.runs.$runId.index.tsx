...
function ResearchRunPage() {
  ...
  // through the shared predicate in `@/lib/active-space-sync` — so a run opened from a
  // research mail can never show one client up there and another's run down here. The
  // `cancelled` guard above it stays: a sync after unmount is pointless.
  //

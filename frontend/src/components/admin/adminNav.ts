// Shared superadmin nav items for the management screens (users / spaces).
// Used both by the ProductShell sidebar section and as the `items` for the management
// routes' shell so the screens are mutually reachable.
...
// Beheer routes rely on reference equality.
